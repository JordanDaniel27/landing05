    ...
    theme: {
        extend: {
            ...
            fontFamily: {
                ...
                grotesk: ["groteskMedium", "sans-serif"],
            },
            fontSize: {
            ...
            backgroundImage: {
                ...
                fondoMain:
                    "url('../../public/images/img/imgMundoWeb/image_2.png')",
                fondoMainBigger:
                    "url('../../public/images/img/imgMundoWeb/image_14.png')",

                fondoMainMobile:
                    "url('../../public/images/img/imgMundoWeb/image_33.png')",

                fondoMainBiggerMobile:
                    "url('../../public/images/img/imgMundoWeb/image_34.png')",
            },
